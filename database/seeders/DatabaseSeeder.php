    ...
    public function run(): void
    {
        ...
        Tool::query()->updateOrCreate(
            ...
            [
                ...
                'description' => 'Gestion automatisée des feuilles de temps pour l\'accélération.',
                'route' => '/timesheets',
        ...
        Tool::query()->updateOrCreate(
            ...
            [
                ...
                'description' => 'Soumettez, suivez et validez en toute transparence vos demandes de congés auprès de l\'administration.',
                'route' => '/conges',
                'status' => Tool::STATUS_ACTIVE,
    ...
    private function employees($departments): array
    {
        return [
            ...
            [
                ...
                'analytic_code' => '1.1.2 Personnel Administratif et Appui',
                'ipas_rate' => 0,
                'catal_rate' => 20,
                'ipde_rate' => 0,
                'requires_other_projects' => true,
